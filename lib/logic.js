...
* @param {org.example.compnetwork.EngineCreation} tx - the transaction to create an engine
* @transaction
*/
...
* @param {org.example.compnetwork.EngineMerchantTransfer} tx - the engine transfer transaction
* @transaction
*/
...
* @param {org.example.compnetwork.EngineCarInstallation} tx - the engine into car installation transaction
* @transaction
*/
